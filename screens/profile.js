        ...
        <View style={styles.container2}>
          <View>
            <Image
              ...
              style={{ width: 130, height: 130, marginBottom: 15, borderRadius: 70, alignSelf: 'center' }}
            />
            ...
            <TouchableOpacity style={styles.editButton} onPress={editProfile}>
              <Text style={[globalStyles.buttonText, { fontSize: 10 }]}>Edit Your Profile</Text>
            </TouchableOpacity>
              ...
              {userBooking.map((user, index) => (
                <React.Fragment key={index}>
                  <Text style={styles.bookings}>
                    Day: {user.date} Hour: {user.time} Guests: {user.guests}
                  </Text>
                </React.Fragment>
              ))}
            </View>

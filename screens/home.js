        ...
        <View style={styles.container}>
            ...
            <View style={styles.hello}>
                ...
                <View style={styles.icons}> 
                    ...
                    <Text style={styles.iconText}>Beverages</Text>
                    </View>
                </View>
            ...
            <View style={styles.reserver}>
                <Text style={styles.titre2}>Book your table in an instant!</Text>
                <Text style={styles.text}>Secure a table easily at our restaurant, exceptional service awaits you</Text>
                <TouchableOpacity style={styles.button} onPress={handleReservation}>
                    <Text style={globalStyles.buttonText}>Take action</Text>
                </TouchableOpacity>
            </View>

            <View style={styles.menu}>
                    <Text style={styles.titre2}>Discover our menu!</Text> 
                    <Text style={styles.text}>Take a look at our various dishes and much more..</Text>                       
                    <TouchableOpacity style={styles.button} onPress={handleDiscoverMenu}>
                        <Text style={globalStyles.buttonText}>Discover</Text>                     
                    </TouchableOpacity>
            </View>
                </View>
            </ScrollView>
